...
/**
 ...
 the container structure Dictionary creates when encoding.
 Since this structure not compatibel with the java implementation
 ...
 Therefor a MapMeta can also be seen as UnkeyedContainerMeta.
 */
internal class MapMeta: KeyedContainerMeta, UnkeyedContainerMeta {
    ...
    /*
     ...
     as container for Dictionarys with arbitrary keys or values
     and as general container backend
    ...
    private class Storage {
        ...
        private func asStringKey(key: Meta) -> String? {
            ...
            } else if key is IntMeta {
                
                return (key as! IntMeta).value.description
                
            } else if key is UIntMeta {
                
                return (key as! UIntMeta).value.description
